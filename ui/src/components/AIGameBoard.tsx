...
export function AIGameBoard({ game, currentAccount }: AIGameBoardProps) {
    ...
    const renderCell = (index: number) => {
        ...
        return (
            <Button
                ...
                disabled={!isEmpty || !canMove || isPending}
                style={{
                    width: "80px",
                    height: "80px",
                    fontSize: "32px",
                    cursor: isEmpty && canMove ? "pointer" : "default",
                    backgroundColor: isEmpty ? "var(--gray-2)" : "var(--gray-6)"
                }}
            >
                {symbol}
            </Button>
    ...
    return (
        <Box style={{ maxWidth: 600, margin: "0 auto" }}>
                ...
                <Flex direction="column" gap="3">
                    <Flex justify="between" align="center">
                        <Flex align="center" gap="2">
                            ...
                            <Heading size="5">AI Battle</Heading>
                        ...
                        <Badge 
                            color={game.game_status === 1 ? "green" : game.game_status === 2 ? "red" : "gray"} 
                            size="2"
                        >
                        ...
                        <Box>
                            {aiThinking && (
                                <Flex align="center" gap="2">
                                    ...
                                    <Text size="2" color="purple">{thinkingMessage}</Text>
                                </Flex>
                            )}
                            ...
                            {isPending && (
                                <Flex align="center" gap="2">
                                    ...
                                    <Text size="2" color="blue">Processing your move...</Text>
                                </Flex>
                            )}
                        </Box>
                    )}
                    ...
                    <Flex direction="column" align="center" gap="4">
                        {game.game_status === 1 && (
                            <>
                                ...
                                <Text align="center">
                                    You defeated the {DIFFICULTY_LABELS[game.difficulty as keyof typeof DIFFICULTY_LABELS]} AI 
                                    in <Strong>{game.moves_count} moves</Strong>!
                                    <br />
            ...
            {/* Game Info */}
            <Card size="2" mt="4">
                <Heading size="4" mb="3">🎮 Game Info</Heading>
